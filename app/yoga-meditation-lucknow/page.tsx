...
import {
  ...
  Clock, Calendar, Users, Activity, Award
} from 'lucide-react';
    ...
    <main className="min-h-screen bg-stone-50 text-stone-800 font-lato">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-stone-900 text-white">
        ...
        <div className="absolute inset-0 z-0">
             <Image
                src="/images/hero/yoga.jpg" // Ensure this image exists
                alt="Dr. Nand Lal Yadav conducting yoga therapy session in Lucknow"
                fill
        ...
        <div className="relative z-20 container mx-auto px-4">
          <div className="max-w-4xl">
             {/* Badge */}
             <div className="inline-block bg-nature-green text-white px-4 py-1.5 rounded-full text-sm font-bold mb-6 animate-fade-in-up">
             ...
             <h1 className="text-4xl md:text-6xl lg:text-7xl font-playfair font-bold mb-6 leading-tight animate-fade-in-up animation-delay-100">
               ...
               <span className="block text-2xl md:text-4xl mt-4 font-light text-stone-200">
                 28 Years Experience | 1 Lakh+ Lives Transformed
               </span>
             </h1>

             {/* Sub-headline */}
             <p className="text-lg md:text-xl text-stone-300 mb-8 max-w-2xl animate-fade-in-up animation-delay-200">
             ...
             <div className="flex flex-col sm:flex-row gap-4 mb-10 animate-fade-in-up animation-delay-300">
               <a href="tel:8115400106" className="bg-nature-green hover:bg-green-700 text-white px-8 py-4 rounded-full font-bold text-lg transition flex items-center justify-center gap-2">
                 <Phone className="w-5 h-5" /> Call Now: 8115400106
               </a>
               <a href="tel:8115400106" className="bg-transparent border-2 border-white hover:bg-white/10 text-white px-8 py-4 rounded-full font-bold text-lg transition flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4">
           <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="lg:w-3/5">
                 ...
                 {/* Credentials Box */}
                 <div className="bg-stone-50 border border-stone-200 p-6 rounded-xl mb-8">
              ...
              <div className="lg:w-2/5 relative">
                 ...
                 {/* Floating Badge */}
                 <div className="absolute -bottom-6 -left-6 bg-nature-green text-white p-6 rounded-xl shadow-xl max-w-[200px] hidden md:block">
         ...
         <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-12">
               ...
               <div>
                  ...
                  <div className="bg-nature-green/5 p-8 rounded-2xl border border-nature-green/10 h-full">
                     <ul className="space-y-6">
                        <li className="flex justify-between items-baseline border-b border-stone-200 pb-3">
                        ...
                        <li className="flex justify-between items-baseline border-b border-stone-200 pb-3">
                           ...
                           <div className="text-right">
                              ...
                              <span className="block text-xs text-green-600">Save ₹600</span>
                           </div>
                        </li>
                        <li className="flex justify-between items-baseline border-b border-stone-200 pb-3">
                     ...
                     <div className="mt-8 space-y-3">
                        <a href="tel:8115400106" className="block w-full bg-nature-green text-white text-center py-4 rounded-full font-bold hover:bg-green-700 transition">
      ...
      <section className="py-16 bg-stone-900 text-white">
         <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 h-[500px] md:h-[450px]">
               {/* Map Placeholder */}
               <div className="bg-stone-800 rounded-2xl overflow-hidden relative">
                  <iframe
               ...
               {/* Contact Info */}
               <div className="flex flex-col justify-center p-8 bg-stone-800 rounded-2xl">
                  <div className="space-y-6">
      ...
      <section className="py-16 md:py-24 bg-white">
         <div className="container mx-auto px-4">
            ...
            <div className="mt-12 text-center">
               <a href="tel:8115400106" className="inline-block border-2 border-stone-800 text-stone-800 px-8 py-3 rounded-full font-bold hover:bg-stone-800 hover:text-white transition">
            ...
            <div className="grid md:grid-cols-3 gap-8">
               {[
                 ...
                 <div key={i} className="group cursor-pointer">
                    ...
                    <span className="text-nature-green font-bold text-sm">Read Article →</span>
                 </div>
               ))}
            </div>
         </div>
      ...
      <section className="py-20 bg-nature-green text-white text-center relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 z-10">
           ...
           <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
             <a href="tel:8115400106" className="bg-white text-nature-green px-10 py-4 rounded-full font-bold hover:bg-stone-100 transition shadow-lg text-lg flex items-center justify-center gap-2">
               <Phone className="w-5 h-5" /> Call Now: 8115400106
             </a>
             <a href="tel:8115400106" className="bg-transparent border-2 border-white text-white px-10 py-4 rounded-full font-bold hover:bg-white/10 transition text-lg">
               Book FREE Trial Class
             </a>
           </div>
      ...
      {/* FOOTER SECTION (Page Specific as per draft) */}
      <footer className="bg-stone-900 text-stone-400 py-12 border-t border-stone-800">
         <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8 mb-12">
               {/* Col 1 */}
               <div>
                  <h4 className="text-white font-bold text-lg mb-4">Natural Treatment Hospital</h4>
                  <p className="text-sm leading-relaxed mb-4">
                     Led by Dr. Nand Lal Yadav. Lucknow&apos;s most experienced yoga therapist with 28 years of clinical practice. Specialized in treating chronic lifestyle diseases.
                  </p>
               </div>
               ...
               <div>
                  ...
                  <ul className="space-y-2 text-sm">
                     <li><Link href="/" className="hover:text-nature-light-green transition">Home</Link></li>
                     <li><Link href="/yoga-therapist/nand-lal-yadav" className="hover:text-nature-light-green transition">About Dr. Nand Lal Yadav</Link></li>
                     <li><Link href="/contact" className="hover:text-nature-light-green transition">Contact Us</Link></li>
                  </ul>
               </div>
               ...
               <div>
                  ...
                  <ul className="space-y-2 text-sm">
                     ...
                     <li>Yoga for Back Pain</li>
                     <li>Yoga for PCOD/PCOS</li>
               ...
               <div>
                  ...
                  <ul className="space-y-3 text-sm">
                     <li className="flex gap-3">
                        ...
                        <span>CP-143, Viraj Khand, Gomti Nagar, Lucknow</span>
                     </li>
                     <li className="flex gap-3">
                        <Phone className="w-5 h-5 shrink-0" />
                        <span>+91-8115400106</span>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div className="border-t border-stone-800 pt-8 text-center text-xs text-stone-600">
               <p className="mb-2">© 2024 Natural Treatment Hospital Lucknow | All Rights Reserved</p>
               <p className="leading-relaxed">
                  Serving Areas: {SEO_AREAS.join(", ")}
               </p>
            </div>
         </div>
      </footer>
