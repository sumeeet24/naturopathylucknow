      ...
      <div className="container relative mx-auto px-4 z-10 flex flex-col items-center justify-center text-center">
        <div className="w-full lg:w-9/12 xl:w-8/12 animate-fade-in-up">
          ...
          <div className="relative mb-8">
            {/* Intro Text - "Best Naturopathy in Lucknow" - Fades Out */}
            <div className="animate-fade-out-delayed absolute inset-0 flex items-center justify-center">
              <h2 className="font-serif font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.1] drop-shadow-2xl tracking-tight text-white/90">
                Best Naturopathy in Lucknow
              </h2>
            </div>

            {/* Main H1 - "Natural Treatment..." - Fades In */}
            <h1 className="font-serif font-bold text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[1.1] drop-shadow-2xl tracking-tight text-white animate-fade-in-delayed opacity-0">
              {HERO_TITLE}
            </h1>
          </div>
