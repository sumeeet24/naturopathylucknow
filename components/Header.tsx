...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Navigation - Moved outside header to avoid stacking context issues */}
      <div
        className={`lg:hidden fixed inset-0 z-[99] bg-white transform transition-transform duration-500 ease-in-out ${
          isOpen ? 'translate-x-0' : 'translate-x-full'
        }`}
        style={{ paddingTop: '80px' }} // Offset for header height
      >
