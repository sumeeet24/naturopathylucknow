...
const Header: React.FC = () => {
  ...
  return (
    <header
        className={`fixed w-full top-0 z-[9999] transition-all duration-500 border-b ${
            scrolled
