        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-7/12">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="https://wa.me/918115400106?text=Hi,%20I%20would%20like%20to%20book%20an%20appointment%20with%20Dr.%20Nilam."
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center bg-[#25D366] text-white px-8 py-4 rounded-full font-bold hover:bg-green-600 transition-colors duration-300 shadow-lg"
              >
                <span>WhatsApp</span>
              </a>
            </div>
