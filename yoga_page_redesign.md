...
2. ✅ Create/optimize Google Business Profile with:
   - All services listed
   - Professional photos (minimum 10)
   - Operating hours updated
   - Website link added
   - Dr. Yadav's qualifications in description
3. ✅ Get initial 10-15 patient reviews on Google
4. ✅ Submit to local directories:
   - Justdial
   - Sulekha
   - UrbanPro
   - Practo (if healthcare listing)
   - IndiaMART
   - Yellow Pages India

### Week 2-4 Actions:
1. ✅ Create social media posts linking to this page
2. ✅ Start email marketing to existing patient database
3. ✅ Create 3-4 blog